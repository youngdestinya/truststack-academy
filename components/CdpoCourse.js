  ...
  return <>
    ...
    <div className={styles.page}>
      ...
      <section className={styles.hero}><div className={styles.heroInner}>
        ...
        </div><div className={styles.heroVisual} aria-hidden="true"><div className={styles.visualTop}><span>TRUSTSTACK / CDPO</span><span>OPEN ACCESS</span></div><div className={styles.visualShield}>◈</div><div className={styles.visualBig}>30<span>DAY STUDY PATH</span></div><div className={styles.visualBottom}><span>ACT 2023</span><span>SCENARIOS</span><span>PRACTICE EXAM</span></div></div>
      </div></section>
