...
export function makeLearner({track,payment_digest}){
 ...
 learner.verify_url=`${process.env.NEXT_PUBLIC_BASE_URL || 'https://truststack-academy.vercel.app'}/learner?id=${learner.id}`;
 return learner;
}
