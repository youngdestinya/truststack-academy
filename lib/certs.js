...
export function makeCert({student,track,date_issued}) {
 ...
 const cert={id:`${new Date().getUTCFullYear()}-${hex}`,student:student.trim(),track:track.trim(),date_issued:date,hash_prefix:hex,status:'verified',signed_by:'Destiny Young',signer_title:'Founder/Chief Technology Officer, Truststack Technologies',signed_for:'Truststack Academy'};
