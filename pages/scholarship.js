...
export default function Scholarship(){
  ...
  return <>
    ...
    <div className={styles.page}>
      <header className={styles.header}><Link href="/" className={styles.brand}><img src="/truststack-home-logo.png" alt="TrustStack Academy official logo"/><strong>TrustStack Academy</strong></Link><nav><Link href="/">Home</Link><Link href="/courses-tracks.html">Career tracks</Link><Link href="/privacy">Privacy</Link></nav></header>
      <main>
