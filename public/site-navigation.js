(function () {
  ...
  function applyStaticSeo() {
    ...
    const socialImage = isHome ? `${origin}/hero-cyber-lab-v2.jpg` : `${origin}/cdpo-og.png`;
  ...
  function addFooterResources() {
    ...
    hqBox.style.cssText = 'margin-top:1.25rem;padding-top:.85rem;border-top:1px solid rgba(255,255,255,.12);font-size:.78rem;line-height:1.45;color:rgba(255,255,255,.7);';
    hqBox.innerHTML = `
      <div style="font-weight:800;color:#D4AF37;letter-spacing:.08em;margin-bottom:4px;display:flex;align-items:center;gap:4px;">
        <span>📍</span> CORPORATE HEADQUARTERS
      </div>
      <address style="font-style:normal;color:rgba(255,255,255,.8);font-size:.78rem;line-height:1.45;">
        25 Destiny Young Avenue, GRE<br>
        Ewet Housing Extension, Uyo 520101<br>
        Akwa Ibom State, Nigeria
      </address>
    `;
    resourceColumn.appendChild(hqBox);
